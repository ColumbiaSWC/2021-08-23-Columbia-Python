...
humandate: "August 23-24, 2021"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 AM - 4:30 PM"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2021-08-23      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2021-08-24        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Jonathan Reeve", "Paul Bloom", "Aaron Tran", "Alan Crosswell"]
helper: ["TBA"]
...
<a href="https://swcarpentry.github.io/python-novice-gapminder/files/python-novice-gapminder-data.zip">python-novice-gapminder-data.zip</a>.
In order to follow the presented material, you should launch the JupyterLab
server in the root directory (see <a href="https://swcarpentry.github.io/python-novice-gapminder/01-run-quit/#starting-jupyterlab">Starting JupyterLab</a>).</p>
